...
const LINK_VYSLEDKY = "/prijimacky/vysledky-a-zapis";
...
export function TerminyAKapacitaContent() {
  ...
  return (
    <main
      id="prijimacky-terminy-a-kapacita"
    ...
    >
      <div className={`${CX} pt-6 md:pt-8`}>
        <nav className="mb-8 text-sm text-brand-fg3" aria-label="Oblasť stránky">
          ...
          <span className="text-brand-fg2">Termíny a kapacita</span>
        </nav>
      </div>
        ...
        >
          <div className="max-w-3xl">
            ...
            <p className="m-0 mt-6 max-w-2xl text-[15px] font-normal leading-relaxed text-brand-fg1/88 sm:text-[16px] md:mt-7 md:text-[17px] md:leading-[1.65]">
              Všetky dôležité dátumy a základné informácie o počte miest na jednom
              mieste.
            </p>
      ...
      >
        ...
        <div className="relative mx-auto max-w-5xl">
          <div
            className="absolute left-[1.35rem] top-8 bottom-8 hidden w-px bg-gradient-to-b from-[#fdb913]/80 via-black/[0.12] to-[#fdb913]/40 md:block lg:left-1/2 lg:-ml-px"
            aria-hidden
          />
            ...
            {terminy.map((t, i) => (
              ...
              >
                <div className="flex gap-4 md:gap-5 lg:items-start">
                  <span
                    className="font-heading flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#fdb913] text-lg font-bold text-brand-fg1 shadow-md md:h-12 md:w-12 md:text-xl lg:relative lg:z-10"
                    aria-hidden
                  >
                    {t.step}
                  </span>
      ...
      {/* 4. Praktický blok */}
      <section className={CX} aria-labelledby="heading-oci">
        <div className="mx-auto max-w-2xl rounded-2xl bg-brand-bg2/80 px-6 py-8 ring-1 ring-black/[0.06] md:px-10 md:py-9">
          <h2
            id="heading-oci"
            className="font-heading m-0 text-center text-[clamp(1.15rem,1rem+0.8vw,1.45rem)] font-bold text-brand-fg1"
          >
            Maj všetko na očiach
          </h2>
          <p className="m-0 mt-4 text-center text-[15px] leading-relaxed text-brand-fg2 md:text-base">
            Ak si chceš prejsť ďalšie kroky prijatia, pozri si aj podstránky o{" "}
            <Link
              href={LINK_CO}
      ...
      <div className={`${CX} ${sectionGap}`}>
        ...
        >
          <div className="mx-auto max-w-2xl text-center">
            ...
            >
              Chceš vedieť, čo nasleduje?
            </h2>
            <p className="m-0 mt-4 text-[15px] leading-relaxed text-brand-fg1/90 md:mt-5 md:text-[17px]">
              Pozri si, ako sa dostať na Lýceum alebo čo bude nasledovať po
              prijímačkách.
            </p>
