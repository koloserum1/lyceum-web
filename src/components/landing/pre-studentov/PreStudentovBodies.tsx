...
function Stravovanie() {
  return (
    <div className="max-w-3xl space-y-0 text-brand-fg1">
      ...
      <p className={p}>
        <a href="tel:+421911839075" className="text-brand-primary underline">
          0911 839 075
        </a>
        {" "}
      ...
      <p className={p}>
        <strong className="font-semibold text-brand-fg1">Čas výdaja:</strong>{" "}
        11:30 – 14:15
      </p>
      <p className={p}>
        <strong className="font-semibold text-brand-fg1">Miesto:</strong>{" "}
        školská jedáleň (prízemie)
      </p>

      <h3 className={h3}>Koľko to stojí (platné od 1. 9. 2025)</h3>
      <ul className="m-0 mt-3 list-none space-y-2 p-0 text-[15px] leading-relaxed text-brand-fg1 sm:text-[16px] md:text-[17px]">
        <li>
          <span className="text-brand-fg3">obed:</span>{" "}
          <strong className="font-semibold text-brand-fg1">2,50 €</strong>
        </li>
        <li>
          <span className="text-brand-fg3">mesačná réžia:</span>{" "}
          <strong className="font-semibold text-brand-fg1">16,50 € / mesiac</strong>
        </li>
      </ul>
      <p className={p}>
      ...
      <p className={p}>
        <span className="text-brand-fg3">Vegánske menu (VEGE):</span>{" "}
        <strong className="font-semibold text-brand-fg1">4,50 €</strong>
      </p>
      ...
      <p className={p}>
        <strong className="font-semibold text-brand-fg1">Prihlásenie:</strong>{" "}
      ...
      <p className={p}>
        <strong className="font-semibold text-brand-fg1">Odhlásenie:</strong>{" "}
